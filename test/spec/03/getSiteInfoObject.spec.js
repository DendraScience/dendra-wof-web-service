/**
 * getSiteInfoObject handler tests
 */
...
import { getSiteInfoObject } from '../../../src/soap/handlers/GetSiteInfoObject.js'
...
describe('GetSiteInfoObject handlers', function () {
  afterEach(() => {
    sinon.restore()
  })
  ...
  it('should handle getSiteInfoObject with station, datastreams, params, uoms and variableTimeInterval', async function () {
    ...
    const response = fs.readFileSync(
      path.resolve(
        __dirname,
        '../../data/GetSiteInfoObject/responses/variableTimeInterval.xml'
      ),
      'utf8'
    )
  ...
  it('should handle getSiteInfoObject with station, params, uoms and no datastream', async function () {
    ...
    const response = fs.readFileSync(
      path.resolve(
        __dirname,
        '../../data/GetSiteInfoObject/responses/station-and-params-and-uoms-and-no-datastream.xml'
      ),
      'utf8'
    )
    expect(result).to.equal(response)
  ...
  it('should handle getSiteInfoObject with station, datastreams, params and uoms', async function () {
    ...
    const response = fs.readFileSync(
      path.resolve(
        __dirname,
        '../../data/GetSiteInfoObject/responses/station-and-datastream-params-and-uoms.xml'
      ),
      'utf8'
    )
    expect(result).to.equal(response)
