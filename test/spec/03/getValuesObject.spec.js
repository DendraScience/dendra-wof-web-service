...
import { getValuesObject } from '../../../src/soap/handlers/GetValuesObject.js'
...
describe('GetValuesObject handlers', function () {
  afterEach(() => {
    sinon.restore()
  })

  it('should handle getValuesObject with station and datastream', async function () {
    const method = 'GetValuesObject'
    const parameters = {
    ...
    // For getValuesObject, we need to fake out  findMany() and org()
    ...
    const response = fs.readFileSync(
      path.resolve(
        __dirname,
        '../../data/GetValuesObject/responses/station-and-datastream.xml'
      ),
      'utf8'
    )
